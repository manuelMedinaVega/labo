...
hs <- makeParamSet( 
         ...
         makeIntegerParam("min_data_in_leaf", lower=    500L   , upper=  8000L),#lower = 500L
         ...
         makeNumericParam("lambda_l1", lower=0.0),
         makeNumericParam("lambda_l2", lower=0.0),
         makeNumericParam("min_gain_to_split", lower=0.0)
        )
#max_bins
...
PARAM$trainingstrategy$semilla_azar   <- 309367  #Aqui poner la propia semilla
...
PARAM$hyperparametertuning$semilla_azar  <- 309367  #Aqui poner la propia semilla, PUEDE ser distinta a la de trainingstrategy
