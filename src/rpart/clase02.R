...
## - ¿Se podría cortar en más intervalos? sí, pero es más costoso
## - ¿Cuál sería el costo? 
...
##   clasificación de los registros? la que tenía la mayor cantidad
## - ¿Cuántas hojas con BAJAS+2 hay? ninguna
...
#cuanto tolero los errores, cuanto puede llegar a fallar un test
